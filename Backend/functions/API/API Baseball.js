...
const API_KEY = ''
const BASIC_URL = "https://v1.baseball.api-sports.io"
const RAPIDAPI_HOST = 'v1.baseball.api-sports.io'
...
*/
async function getBaseballLeagues(props){
    ...
    try{
      ...
      if (response["status"]==200){
        ...
        console.log("Error in getBaseballLeagues().")
        return []
      }
    }catch(error){
      console.log("Error in getBaseballLeagues().")
...
*/
async function getBaseballTeams(props){
    ...
    try{
      ...
      if (response["status"]==200){
        ...
        console.log("Error in getBaseballTeams().")
        return []
      }
    }catch(error){
      console.log("Error in getBaseballTeams().")
...
*/
async function getBaseballTeamsStatistics(props){
    ...
    try{
      ...
      if (response["status"]==200){
        ...
        console.log("Error in getBaseballTeamStatistics().")
        return []
      }
    }catch(error){
      console.log("Error in getBaseballTeamStatistics().")
...
async function getBaseballLeagueStandings(props){
    ...
    try{
      ...
      if (response["status"]==200){
        ...
        alert("Unable to get information at the moment.")
        return []
      }
    }catch(error){
      console.log("Error in getBaseballLeagueStandings().")
      console.log(error)
    }
...
async function getBaseballGames(props){
    ...
    try{
      ...
      if (response["status"]==200){
        ...
        console.log("Error in getBaseballGames().")
        return []
      }
    }catch(error){
      console.log("Error in getBaseballGames().")
...
*/
async function getBaseballGamesH2H(props){
    ...
    try{
      ...
      if (response["status"]==200){
        ...
        console.log("Error in getBaseballGamesH2H().")
        return []
      }
    }catch(error){
      console.log("Error in getBaseballGamesH2H().")
...
module.exports = {getBaseballGames, getBaseballGamesH2H,getBaseballLeagueStandings,getBaseballLeagues,getBaseballTeams,getBaseballTeamsStatistics}